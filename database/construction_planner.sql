...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 12, 2024 at 10:19 AM
...
CREATE TABLE `architecture_booking` (
  ...
  `house_plan_updation_chat` varchar(1000) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE `contractor_booking` (
  ...
  `contract_details_updation_chat` varchar(1000) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE `designer_booking` (
  ...
  `house_3d_plan_updation_chat` varchar(1000) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
--
ALTER TABLE `architecture`
  MODIFY `architecture_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
