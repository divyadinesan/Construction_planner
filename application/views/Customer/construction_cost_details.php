...
{
?>
<form method="post" action="<?php echo base_url('index.php/Customer_controller/construction_cost_updation_message')?>">
  <td>
    <input type="hidden" name="contractor_booking_id" value="<?php echo $fetch->contractor_booking_id ?>">
  <input type="text" name="construction_cost_updates">
  <br><br>
