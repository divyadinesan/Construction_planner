...
<br><br>
               ...
               <form action="<?php echo base_url('index.php/Customer_controller/Customer_profile_update/'.$fetch->customer_id)?>" method="post" name="login" enctype="multipart/form-data">
                     ...
                     <input type="text" name="name"   id="name"  value="<?php echo $fetch->customer_name?>" style="width: 400px;border-radius: 15px;height: 40px;padding-left: 15px" pattern="[A-Za-z]{1,32}"><br><br>
                  </div>
                  <div  >
                    ...
                    <div  >
                     ...
                     <input type="text" name="phone"  value="<?php echo $fetch->customer_phone?>" style="width: 400px;border-radius: 15px;height: 40px;padding-left: 15px" maxlength="10" pattern="\d{10}"><br><br>
                  </div>
