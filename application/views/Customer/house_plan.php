...
<div style="overflow-x:auto;">
  <table>
    ...
    {
    ?>
    <th>Drop Your Plan Updates Here</th>
    <?php
  }
  ?>
...
{
?>
<form method="post" action="<?php echo base_url('index.php/Customer_controller/house_plan_updation_message')?>">
  <td>
    <input type="hidden" name="architecture_booking_id" value="<?php echo $fetch->architecture_booking_id ?>">
  <input type="text" name="plan_updates">
  <br><br>
