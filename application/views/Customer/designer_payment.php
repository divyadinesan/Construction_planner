...
<!------ Include the above in your HEAD tag ---------->
   ...
   <div class="col-md-6 offset-md-3">
                    ...
                    <hr class="my-5">
                    <?php
                    foreach ($booking_designer as $fetch) 
                      # code...
                    ...
                    <div class="card card-outline-secondary">
                        <div class="card-body">
                            ...
                            <form class="form" role="form" autocomplete="off" method="post" action="<?php echo base_url('index.php/Customer_controller/designer_payment_insert')?>">
                              ...
                              <input type="hidden" name="customer_id" value="<?php echo $fetch->db_customer_id?>">
                               <input type="hidden" name="customer_email" value="<?php echo $fetch->db_customer_email?>">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="cc_name" placeholder="eg: Divya M D" required="required" name="card_name">
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-inline">
                                    <div class="input-group">
                                        ...
                                        <input type="text" class="form-control text-right" id="exampleInputAmount" value="<?php echo $fetch->d_fee_amount?>" name="amount">
                            ...
                            <a href="<?php echo base_url('index.php/Customer_controller/My_designer_booking')?>">
