                 ...
                 <div class="form-group">
                  ...
                  <div class="form-group">
                    ...
                    <div class="form-group">
                     ...
                     <input type="tel" name="phone"  class="form-control my-input" id="name" placeholder="" required="" autocomplete="off" maxlength="10" pattern="\d{10}" >
                  </div>
                 
                  <div class="form-group">
                      <label>Customer Address</label>
                     <input type="text" name="address"  class="form-control my-input" id="email" placeholder="" required="">
                  </div>
                   <div class="form-group">
