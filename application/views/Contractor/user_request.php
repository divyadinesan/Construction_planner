...
?> 
    ...
    <div class="card">
      ...
      ?>
       <p style="color: BLACK;">Payment Status : <?php echo $fetch->cb_payment_status?></p>
        ...
        <br>
        <label style="color: black"><b>upload Construction Cost Details PDF</b></label><br><br>
 ...
 <p style="color: BLACK;">3D Plan : <br>
  <img src="<?php echo base_url('Asset/Customer/contractor_3dhouse_plan/'.$fetch->cb_house_3d)?>" style="height: 200px;width: 300px;">
