   ...
   <br><br>
           ...
           <br><br>
               ...
               <form action="<?php echo base_url('index.php/Designer_controller/designer_update/'.$fetch->designer_id)?>" method="post" name="login" enctype="multipart/form-data">
                     ...
                     <input type="text" name="name"  class="form-control my-input" id="name" placeholder="" value="<?php echo $fetch->d_name?>"style="width: 400px;border-radius: 15px;height: 40px;padding-left: 15px" pattern="[A-Za-z]{1,32}">
                  </div>
                  <div class="form-group">
                     <label>Email</label>
                  ...
                  <div class="form-group">
                     ...
                     <input type="text" name="phone"  class="form-control my-input" id="name" placeholder=""value="<?php echo $fetch->d_phone?>"style="width: 400px;border-radius: 15px;height: 40px;padding-left: 15px" maxlength="10" pattern="\d{10}">
                  </div>
                  <div class="form-group">
