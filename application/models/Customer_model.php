...
class Customer_model extends CI_Model {
	...
	public function house_plan_updation_message_model($arrdata,$architecture_booking_id)
	{
		$this->db->where('architecture_booking_id',$architecture_booking_id);
		return $this->db->update('architecture_booking',$arrdata);
	}
	public function house_3dplan_updation_message_model($arrdata,$designer_bookingid)
	{
		$this->db->where('db_designer_bookingid',$designer_bookingid);
		return $this->db->update('designer_booking',$arrdata);
	}
	public function construction_cost_updation_message_model($arrdata,$contractor_booking_id)
	{
		$this->db->where('contractor_booking_id',$contractor_booking_id);
		return $this->db->update('contractor_booking',$arrdata);
	}
